...
namespace lkogl {
    namespace graphics {
        namespace lighting {
            ...
            {
                program.setUniform("uDirectionalLight.baseLight.color", l.baseLight_.color_);
                program.setUniformf("uDirectionalLight.baseLight.intensity", l.baseLight_.intensity_);
